...
import Feat1 from '../assets/images/promo-feat-1.png';
import Feat2 from '../assets/images/promo-feat-2.jpg';
...
export const allFeatures: Feature[] = [
  {
    ...
    description:
      'Get your order delivered to your doorstep at the earliest from the stores near you.',
  },
  {
    imgSrc: Feat2,
  ...
  {
    imgSrc: Feat4,
    text: 'Easier Returns/Refund',
    description:
      'Not satisfied with a product? Return it at the doorstep & get a refund within minutes.',
  },
];
        ...
        <div className="flex flex-col gap-8 lg:border-t _border-muted lg:pt-20">
                ...
                <div className="hidden lg:flex items-center _bg-shade-2 p-3 mt-6 gap-3 rounded-xl">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="font-extrabold text-lg max-w-[300px] _text-default">
                      Simple way to download the FreshMart app
                    </p>
          ...
          <div className="border-b _border-light pt-2 pb-10">
            <p className="text-sm _text-default">
              "FreshMart" is owned & managed by "Fresh Commerce Private Limited"
